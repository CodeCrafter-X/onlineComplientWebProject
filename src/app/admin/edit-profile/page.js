        ...
        <div className="max-w-2xl mx-auto">
          ...
          {admin && (
            <div className="bg-white rounded-lg shadow-lg p-8">
              <h1 className="text-3xl font-bold text-gray-900 mb-8">Edit Admin Profile</h1>
              ...
              <div className="mb-12 pb-8 border-b border-gray-200">
                ...
                <div className="flex flex-col sm:flex-row gap-8">
                  <div className="flex-shrink-0">
                    <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-red-500 shadow-lg bg-gradient-to-br from-red-400 to-orange-500 flex items-center justify-center">
                      {previewImage ? (
                        <img
                          src={previewImage}
                          alt="Profile preview"
                  ...
                  <div className="flex-grow flex flex-col justify-center gap-4">
                    ...
                    <label
                      ...
                      className="px-6 py-3 bg-red-100 text-red-600 font-semibold rounded-lg hover:bg-red-200 cursor-pointer transition-colors text-center"
                    >
                      📷 Choose Image
                    </label>
              ...
              <form onSubmit={handleSaveProfile} className="space-y-6">
                ...
                <div className="pt-6 border-t border-gray-200 flex gap-4">
                  <button
                    type="submit"
                    disabled={saving}
                    className="flex-1 px-6 py-3 bg-red-600 text-white font-semibold rounded-lg hover:bg-red-700 transition-colors disabled:bg-gray-400"
                  >
